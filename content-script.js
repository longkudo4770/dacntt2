...
function drawVideo(ctx, screen, camera) {
    ...
    //camera
    const cameraX = 0.725 * ctx.canvas.width; //0.6 la dat tu nua ben phai canvas tro di
    const cameraY = 0.725 * ctx.canvas.height;
    ...
    shadow.innerHTML = `
        ...
        <div>
            <div class="rsd-cameraoverlay">
                <video id="rsd-camera" autoplay muted></video>
                <video id="rsd-screen" autoplay></video>
